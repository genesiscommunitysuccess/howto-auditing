package tradeaudit.utilities.playwright_driver;
...
public abstract class PlaywrightDriver {
    ...
    private static final String browserName = System.getProperty("browser") == null ? configReader.readProperty("browser") : System.getProperty("browser");
